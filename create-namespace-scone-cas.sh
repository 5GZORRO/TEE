...
PUBLIC_CAS_MRENCLAVE=3061b9feb7fa67f3815336a085
f629a13f04b0a1667c93b14ff35581dc8271e4
...
docker run -v ${PWD}/../cas/:/root/.cas/ -it registry.scontain.com:5050/sconecuratedimages/sconecli:latest scone session create namespace-sess.yaml > create-namespace-scone-cas.log
